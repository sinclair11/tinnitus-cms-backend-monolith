...
public class Constants {
    public final static String objectStorageNamespace = "lrvrqsienkzb";
    public final static long tokenDuration = 1000 * 60 * 30;
    ...
    public final static String samplesPath = System.getProperty("user.dir") + "/assets/samples";
}
